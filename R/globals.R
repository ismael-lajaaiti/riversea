utils::globalVariables(c(
  "abundance", "abundance_cor", "Age", "Annee", "batch_size", "C_VALIDE",
  "Campagne", "category", "CdEuMasseD", "code", "CommonessII",
  "connectance", "Coord_Deb_xmin", "Coord_Deb_ymin", "Coord_Fin_xmin",
  "Coord_Fin_ymin", "date_operation", "dist_km", "dist_to_district",
  "district", "eat", "ELEVATION_IGN25M", "Espece", "estimate", "fish",
  "FoodI", "FoodII", "FoodIII", "frac_piscivorous", "from", "from_label",
  ...
  "method", "Mois", "mu", "n_measured", "n_missing", "n_obs", "name",
  "nearest_idx", "Nind_esp", "Nind_esp_taille", "node_id", "Nombre",
  ...
  "reference", "response", "Response", "sandre_code", "scientific_name",
