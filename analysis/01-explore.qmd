...
- [x] Re-organize notebook.
- [x] Cross-validation for estimated elevation data.
- [x] Estimate missing values in environmental data.
- [x] Plot stations on top of hydrographic bassin.
