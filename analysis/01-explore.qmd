...
First step is to get site coordinates in meters.
...
Then we can build the mesh and visualise it.
...
### 4.3.1. Besag random effect



# TODO

- [ ] Fit SPDE model and visualise RE on the map.
