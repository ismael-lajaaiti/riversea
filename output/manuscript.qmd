...
- @Ho-etal-2022 how freshwater and terrestrial food webs change along elevation
gradient.
...
- @Wang-etal-2025 microcosm experiments supporting that unidirectional flow
accumulates nutrients downstream.
...
- @Tadiri-etal-2024 experimental test of @McCann-etal-2021c, found that nutrient
instability can propagate at long distance.

- @Thompson-Gonzalez-2017 dispersal ensures that network can preserve similar
structure when undergo
...
- @Rogers-etal-2024 found that top-down and bottom-up effect varied along the
estuary gradient.

- @Carvajal-Quintero-etal-2026 found that decreasing fish body-size led to
increase connectance and generalism.

- @Finneran-etal-2026b plant productivity similarity predicts food web
similarity at continental scale.

- @Bauer-etal-2022 Species composition strongly changes with environmental
gradients, but - because of resource-limiting constraints - food web structure
does not.
...
- @Elser-etal-2007 find a similar N and P limitations in terrestrial and freshwater
ecosystems; stronger N limitation in marine systems; overall, strong synergestic
effect of N and P enrichment.

- @Cook-etal-2018 shows that the % of fertilized land in a catchment predicts
the proportion of malgroalgae in the estuary.
