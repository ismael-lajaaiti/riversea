...
@Danet-etal-2021;
@Bonnaffé-etal-2024;
@Boettiger-Lang-Wainwright-2012
:::
...
![](../assets/fishing-op-selected.png){fig-align="center" width="60%"}
...
::: {.column width="60%"}
![](assets/fig-ame-main-effects.png){fig-align="left" width="60%"}
:::
...
::: {.column width="30%"}
![](../assets/H3-sketch.png){fig-align="right" width="70%"}
:::

::: {.column width="70%"}
![](../assets/sketch-results-h3.png){width="80%"}
:::
...
::: {.column width="70%"}
![](assets/fig-partial-dams-distance.png){fig-align="left" width="90%"}
:::
