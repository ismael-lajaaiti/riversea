...
**Algae blooms** can be caused by upstream nutrient loading.
:::
:::
...
- Different methods (e.g. statistical models)
- **Different datasets**
:::

::::

# How nutrient loading and dams impact food web structure **along the river-sea continuum**? {background-color="#40666e"}
...
::: {.fragment}
[Are different ecosystems comparable?]{.alert}
:::
:::
